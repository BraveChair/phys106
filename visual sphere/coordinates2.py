#code from https://community.plotly.com/t/can-i-do-scatter3d-in-spherical-coordinates/60535/5
...
np.random(2022) #generates random and ensures
...
R = 1.5
theta_m = 15   #theta min
theta_M = theta_m + 40  #theta max
phi_m= 70    #phi min
phi_M=  phi_m +50   #phi max
